                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                           ...
                                           am-badge-<?= (($item['goods_status']['value'] == 10 && $item['start_time'] < time()) || ($item['goods_status']['value'] == 20 && $item['end_time'] > time()))? 'success' : 'warning' ?>"
                                                 data-id="<?= $item['goods_id'] ?>"
                                                 data-state="<?= $item['goods_status']['value'] ?>">
                                               <?= (($item['goods_status']['value'] == 10 && $item['start_time'] < time()) || ($item['goods_status']['value'] == 20 && $item['end_time'] > time()))?'上架':'下架' ?>
                                           </span>
                                    </td>
