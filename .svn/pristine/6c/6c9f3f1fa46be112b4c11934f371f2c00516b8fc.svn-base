                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" id='goods-start_time' name="goods[start_time]"
                                           value="<?= $model['start_time'] ? date('Y-m-d H:i', $model['start_time']) : date('Y-m-d H:i') ?>" required>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" id='goods-end_time' name="goods[end_time]"
                                           value="<?= $model['end_time'] ? date('Y-m-d H:i', $model['end_time']) : date('Y-m-d H:i') ?>" required>
                            ...
                            <div class="goods-spec-single"
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-6 am-u-end">
                                        <input type="number" min="0.01" class="tpl-form-input"
                                               ...
                                               value="<?= $model['sku'][0]['sharing_price'] ?>" required id="txt_sharing_price">
                                    </div>
                                    <label class="am-u-sm-3 am-u-end am-form-label" style="text-align: left;">贡献：
                                        <span id="txt_contribution"><?= $model['sku'][0]['sharing_price'] * ($model['contribution_rate'] / 100) ?></span>
                                    </label>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">单买价格 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="number" min="0" class="tpl-form-input" placeholder="不能为0"
                                ...
                                <div class="am-form-group">
                                    ...
                                    <label class="am-u-sm-3 am-u-end am-form-label" style="text-align: left;">
                                        <?php $contribution = $model['sku'][0]['sharing_price'] * ($model['contribution_rate'] / 100) ?>
                                        利润：
                                        <span id="txt_profit"><?= floatval($model['sku'][0]['sharing_price']) - floatval($model['sku'][0]['cost_price']) - $contribution ?></span>，
                                        利润率：
                                        <?php if($model['sku'][0]['sharing_price'] != '0.00'):?>
                                            <span id="txt_profit_rate"><?= number_format(((floatval($model['sku'][0]['sharing_price']) - floatval($model['sku'][0]['cost_price']) - $contribution) / floatval($model['sku'][0]['goods_price'])) * 100, 2, '.', '') ?>%</span>
                                        <?php else: ?>
                                            -
                                        <?php endif;?>
                                    </label>
...
<script>
  $(function () {
    ...
    // 计算贡献
    $("#txt_sharing_price").on("blur", function() {
        var contributionRate = parseFloat($.trim($("#txt_contribution_rate").val())) / 100;
        var goodsPrice = parseFloat($.trim($("#txt_sharing_price").val()));
    ...
    $("#sku-table tbody tr").each(function(idx) {
        if(idx > 0) {
            var obj = $(this).children("td").eq(8);
            var price     = parseFloat($(this).children("td").eq(2).children("input").val());
            var costPrice = parseFloat($(this).children("td").eq(5).children("input").val());
    ...
    $("#sku-table tbody tr").each(function(idx) {
        if(idx > 0) {
            ...
            $(this).children("td").eq(5).children("input").on("blur", function() {
 ...
 function setProfit() {
     ...
     var price      = parseFloat($.trim($("#txt_sharing_price").val()));
     var profit     = parseFloat($.trim($("#txt_sharing_price").val())) - costPrice - contribution;
