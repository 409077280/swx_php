                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3  am-u-lg-2 am-form-label form-require"> 是否开启充值功能 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="recharge[is_recharge]" value="1" data-am-ucheck
                                            <?= $values['is_recharge'] ? 'checked' : '' ?>> 开启
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="recharge[is_recharge]" value="0" data-am-ucheck
                                            <?= $values['is_recharge'] ? '' : 'checked' ?>> 关闭
                                    </label>
                                    <div class="help-block">
                                        <small>小程序端是否开启充值功能，开启则显示，关闭则会隐藏</small>
                                    </div>
                                </div>
                            </div>
                            <div class="am-form-group">
