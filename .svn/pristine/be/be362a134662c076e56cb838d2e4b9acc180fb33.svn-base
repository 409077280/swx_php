...
return [
    ...
    'offlineorder' => [
        ...
        'submenu' => [
            ...
            [
                'name' => '待付款',
                'index' => 'offlineorder/list_nopay',
            ],
            [
                'name' => '已付款',
                'index' => 'offlineorder/list_paid',
            ],
        ]
    ],
    'user' => [
        ...
        'submenu' => [
            ...
            [
                'name' => '提现清单',
                'index' => 'user.withdraw/withdrawfinishpage',
                'uris' => [
                    'user.withdraw/withdrawfinishpage'
                ],
            ],
            [
                'name' => '提现申请',
                'index' => 'user.withdraw/index',
                'uris' => [
                    'user.withdraw/index'
                ],
            ],
...
//                    ],
            ...
            [
                'name' => '新人礼包',
                'index' => 'market.newbie/setting',
            ],
            [
                'name' => '商品分享',
                'index' => 'market.goodsshare/setting',
            ],
            [
                'name' => '用户签到',
                'submenu' => [
                    [
                        'name' => '签到设置',
                        'index' => 'market.usercheckin/setting',
                    ],
                    [
                        'name' => '签到记录',
                        'index' => 'market.usercheckin/record',
                    ],
                ]
            ],
            [
                ...
                'submenu' => [
                    [
                        'name' => '功能设置',
                        'index' => 'market.partner/setting',
                    ],
                    [
                        'name' => '模式说明',
                        'index' => 'market.partner/describe',
                    ],
                ]
            ],
        ],
