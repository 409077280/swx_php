                                ...
                                <div class="am fr">
                                    ...
                                    <div class="am-form-group am-fl">
                                        <select name="pay_type"
                                            ...
                                            <option value="10" <?= $request->get('pay_type') == '10' ? 'selected' : '' ?>>
                                                余额
                                            </option>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (in_array($item['apply_status'], [10, 20])) : ?>
                                                <?php if (checkPrivilege('user.withdraw/submit')): ?>
                                                ...
                                                <?php if ($item['apply_status'] == 20) : ?>
                                                    <?php if (checkPrivilege('user.withdraw/money')): ?>
...
<script id="tpl-dealer-withdraw" type="text/template">
    <div class="am-padding-top-sm">
        <form class="form-dealer-withdraw am-form tpl-form-line-form" method="post"
              action="<?= url('user.withdraw/submit') ?>">
...
<script>
    $(function () {
        ...
        $('.j-money').click(function () {
            var id = $(this).data('id');
            var url = "<?= url('user.withdraw/money') ?>";
