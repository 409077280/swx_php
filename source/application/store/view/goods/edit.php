                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="goods[contribution_rate]"
                                           value="<?= $model['contribution_rate'] ?>" id="txt_contribution_rate">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="tpl-form-input">
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[refund_status]" value="10" data-am-ucheck
                                                <?= $model['refund_status'] == 10 ? 'checked' : '' ?> >
                                            是
                                        </label>
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[refund_status]" value="20" data-am-ucheck
                                                <?= $model['refund_status'] == 20 ? 'checked' : '' ?> >
                            ...
                            <div class="goods-spec-single"
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-7">
                                        <input type="number" class="tpl-form-input" name="goods[sku][goods_price]"
                                               value="<?= $model['sku'][0]['goods_price'] ?>" required id="txt_goods_price">
                                    </div>
                                    <label class="am-u-sm-2 am-u-end am-form-label" style="text-align: left;">贡献：
                                        <span id="txt_contribution"><?= $model['sku'][0]['goods_price'] * ($model['contribution_rate'] / 100) ?></span>
                                    </label>
                                </div>
                                <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-6 am-u-end">
                                        <input type="number" class="tpl-form-input" name="goods[sku][cost_price]"
                                               value="<?= $model['sku'][0]['cost_price'] ?>" id="txt_cost_price">
                                    </div>
                                    <label class="am-u-sm-3 am-u-end am-form-label" style="text-align: left;">
                                        <?php $contribution = $model['sku'][0]['goods_price'] * ($model['contribution_rate'] / 100) ?>
                                        利润：
                                        <span id="txt_profit"><?= floatval($model['sku'][0]['goods_price']) - floatval($model['sku'][0]['cost_price']) - $contribution ?></span>，
                                        利润率：
                                        <?php if($model['sku'][0]['goods_price'] != '0.00'):?>
                                            <span id="txt_profit_rate"><?= ((floatval($model['sku'][0]['goods_price']) - floatval($model['sku'][0]['cost_price']) - $contribution) / floatval($model['sku'][0]['goods_price'])) * 100 ?>%</span>
                                        <?php else: ?>
                                            -
                                        <?php endif;?>
                                    </label>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[to_store]" value="1" data-am-ucheck
                                            <?= $model['to_store'] == 1 ? 'checked' : '' ?> >
                                        是
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[to_store]" value="0" data-am-ucheck
                                            <?= $model['to_store'] == 0 ? 'checked' : '' ?> >
                                        否
                                    </label>
                                </div>
                            </div>

                            <div class="am-form-group" id="express-templat" style="display:<?php if($model['to_store'] == 0): ?>block;<?php else: ?>none;<?php endif; ?>">
                            ...
                            <div class="am-form-group" id="shop-templat" style="display:<?php if($model['to_store'] == 1): ?>block;<?php else: ?>none;<?php endif; ?>">
                            ...
                            <div class="am-form-group" id="start_time_element" style="display:<?php if($model['goods_status']['value'] == 10): ?>block;<?php else: ?>none;<?php endif; ?>">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" id="goods-start_time" name="goods[start_time]"
                                           value="<?= $model['start_time'] ? date('Y-m-d H:i', $model['start_time']) : date('Y-m-d H:i') ?>">
                                    <small>设置商品上架时间，默认为当前时间</small>
                                </div>
                            </div>

                            <div class="am-form-group" id="end_time_element" style="display:<?php if($model['goods_status']['value'] == 20): ?>block;<?php else: ?>none;<?php endif; ?>">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" id="goods-end_time" name="goods[end_time]"
                                           value="<?= $model['end_time'] ? date('Y-m-d H:i', $model['end_time']) : date('Y-m-d H:i', time()) ?>">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="tpl-form-input">
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[support_coupon]" value="0" data-am-ucheck
                                                <?= $model['support_coupon'] == 0 ? 'checked' : '' ?> >
                                            是
                                        </label>
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[support_coupon]" value="1" data-am-ucheck
                                                <?= $model['support_coupon'] == 1 ? 'checked' : '' ?> >
                                            <span class="am-link-muted">否</span>
                                        </label>
                                    </div>
                                </div>
...
<script>
  $(function () {
    ...
    // 计算多规格贡献、利润、利润率
    $("#sku-table tbody tr").each(function(idx) {
        if(idx > 0) {
            var obj = $(this).children("td").eq(7);
            var price     = parseFloat($(this).children("td").eq(2).children("input").val());
            var costPrice = parseFloat($(this).children("td").eq(4).children("input").val());

            setValue(obj, price, costPrice)
        }
    });
    ...
    $("#sku-table tbody tr").each(function(idx) {
        if(idx > 0) {
            var obj = $(this).children("td").eq(7);
            $(this).children("td").eq(2).children("input").on("blur", function() {
                var price     = parseFloat($(this).val());
                var costPrice = parseFloat($(this).parent().next().next().children("input").val());
                setValue(obj, price, costPrice);
            });
            $(this).children("td").eq(4).children("input").on("blur", function() {
                var price     = parseFloat($(this).parent().prev().prev().children("input").val());
  ...
  function setValue(obj, price, costPrice) {
      ...
      $(obj).children("div.contribution").children("label").text(contribution.toFixed(2));
      $(obj).children("div.profit").children("label").text(profit.toFixed(2));
      $(obj).children("div.profit_rate").children("label").text(profitRate.toFixed(2) + '%');
  }
</script>
