                ...
                <form id="my-form" class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">线下订单设置</div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label form-require">贡献率 </label>
                                <div class="am-u-sm-9">
                                    <div class="am-u-sm-6">
                                        <input type="number" class="am-form-field" name="trade[order][contribution_rate]"
                                               value="<?= $values['order']['contribution_rate'] ?>" required>
                                    </div>
                                    <label class="am-u-sm-6 am-form-label am-text-left">%</label>
                                    <div class="help-block am-u-sm-12">
                                        <small>贡献率，默认10%（只需填写数字10，不需填写%）</small>
                                    </div>
                                </div>
                            </div>
