                ...
                <form id="my-form" class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group" data-x-switch>
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">是否新人优惠券 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="coupon[is_newbie]" value="10"
                                               data-am-ucheck
                                               <?= $model['is_newbie'] == '10' ? 'checked' : '' ?>>
                                        是
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="coupon[is_newbie]" value="20"
                                               data-am-ucheck
                                               <?= $model['is_newbie'] == '20' ? 'checked' : '' ?>>
                                        否
                                    </label>
                                </div>
                            </div>
