...
use app\task\model\OrderRefund as OrderRefundModel;
...
class Order extends OrderModel
{
     ...
     * 检查订单是否全部商品都已退款
     */
     public static function isAllRefund($orderId) {
         $refundItems = OrderRefundModel::all(['order_id' => $orderId]);
         $orderItems  = OrderGoodsModel::all(['order_id' => $orderId]);

         return (count($refundItems) == count($orderItems)) ? true : false;
     }
}
